...
const client = new Client()
  .setEndpoint(process.env.NEXT_PUBLIC_APPWRITE_URL) // Set your Appwrite endpoint
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const uploadedFile = await storage.createFile(
        process.env.NEXT_PUBLIC_APPWRITE_CAREERS_BUCKET_ID,
        'unique()',
        file
      );
  ...
  return (
    <div className="bg-gradient-to-b from-slate-900 to-gray-900 min-h-screen text-white py-10 lg:py-22 md:py-32">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-10 lg:mt-7 text-blue-400">
          Join Our Team
        </h1>
        <p className="text-xl text-center mb-12 max-w-3xl mx-auto">
          At AproMax Engineering, we&apos;re always looking for talented
          individuals to join our innovative team. If you&apos;re passionate
          about engineering and want to make a difference, we&apos;d love to
          hear from you!
        </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="Senior Mechanical Engineer">
                    Senior Mechanical Engineer
                  </SelectItem>
                  <SelectItem value="Electrical Systems Designer">
                    Electrical Systems Designer
                  </SelectItem>
                  <SelectItem value="Software Developer (IoT)">
