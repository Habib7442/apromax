...
const Hero = () => {
  return (
    <header className="relative bg-header-1 w-full h-full lg:h-full md:h-full mb-24 lg:mb-0 md:mb-0 sm:py-24 px-5 bg-no-repeat bg-cover bg-center mt-16 lg:mt-10 md:mt-10">
      {/* Main content */}
