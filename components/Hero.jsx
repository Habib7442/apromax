...
const Hero = () => {
  ...
  return (
    <header className="relative bg-header-1 w-full min-h-screen bg-no-repeat bg-cover bg-center mt-2 sm:mt-0 lg:mt-4">
      {/* Main content */}
      <div className="relative z-10 container mx-auto text-center text-white px-4 py-5 sm:py-24 flex flex-col justify-center min-h-screen">
        {/* Main heading */}
